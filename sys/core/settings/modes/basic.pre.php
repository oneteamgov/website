<?php
    ...
    if ($Form->posted() && $Form->validate()) {
    	$postvars = array('headerColour', 'headerScheme', 'lang', 'hideBranding', 'helpURL', 'siteURL', 'dashboard', 'hide_pwd_reset', 'keyboardShortcuts');
    	$checkboxes = array('hideBranding', 'dashboard', 'hide_pwd_reset', 'keyboardShortcuts');
